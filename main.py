...
titulo = Label(frame_escolha, text='TRADUTO DE TEXTOS', height=20, width=20, pady=10, relief='flat', anchor=NW, font='Arial 10 bold', bg=cor4, fg=cor2)
...
botao_taduzir = Button(frame_texto, text='Traduzir', command=traducao, width=5, padx=5, height=0, bg=cor1, fg=cor2, font='Ivy 12 bold', relief=RAISED, overrelief=RIDGE)
botao_taduzir.place(x=210, y=37)
botao_copiar = Button(frame_texto, text='Copiar', command=copiar, width=5, padx=5, height=0, bg=cor1, fg=cor2, font='Ivy 12 bold', relief=RAISED, overrelief=RIDGE)
